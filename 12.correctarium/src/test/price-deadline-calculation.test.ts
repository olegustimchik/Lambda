...
test.each([
    ...
    { lang: "ua/ru", mimetype: "none", count: 2000, orderDate: new Date(1693578960000), expected: { "deadline": 1693824124051, "deadline_date": "09/04/2023 13:42:04", "price": 300, "time": 5.1} },
